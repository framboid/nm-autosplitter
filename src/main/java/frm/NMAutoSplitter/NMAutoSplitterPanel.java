...
public class NMAutoSplitterPanel extends PluginPanel
{
    private final Client client;
    private final NMAutoSplitterConfig config;
    private final NMAutoSplitter splitter;
    private PrintWriter writer;
    private Socket socket;
    private JLabel status;

    @Inject
    NMAutoSplitterPanel(Client client, PrintWriter writer,NMAutoSplitterConfig config, NMAutoSplitter splitter){
        this.client = client;
        this.writer = writer;
        this.config = config;
